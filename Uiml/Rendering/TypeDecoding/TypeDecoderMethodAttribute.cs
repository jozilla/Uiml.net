...
{	
    ...
    public class TypeDecoderMethodAttribute : Attribute
    {
        private Signature m_dependency = new Signature(null, null);
        
        public Signature Dependency
        {
            get { return m_dependency; }
        }
        
        public TypeDecoderMethodAttribute() {}

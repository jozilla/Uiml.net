...
namespace Uiml.Executing.Callers
{
	public abstract class Caller
	{
		...
		protected abstract Type[] CreateInOutParamTypes(Uiml.Param[] parameters, out Hashtable outputPlaceholder);
		public abstract object Execute(out Hashtable outputParams);
	}
}
